describe('Routes', function(){
  ...
  describe('Settings', function(){
    ...
    it("should get it's template from views/settings.html and use the SettingsController", function(){
  ...
  describe('User Settings', function(){
    ...
    it("should get it's template from views/settings/user.html and use the UserSettingsController", function(){
  ...
  describe('Notification Settings', function(){
    ...
    it("should get it's template from views/settings/notifications.html and use the NotificationsSettingsController", function(){
